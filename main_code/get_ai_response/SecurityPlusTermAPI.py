...
class SecurityPlusTermAPI:
    ...
    def define_term(self, term_to_be_defined='ACL'):
        # Define the payload
        data = {
            "contents": [
                {
    ...
    def write_to_file(self, filename='ai_explanation.txt'):
...
if __name__ == '__main__':
    ...
    security_plus_api = SecurityPlusTermAPI(api_key)
